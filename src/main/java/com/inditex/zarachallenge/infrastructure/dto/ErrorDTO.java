...
public class ErrorDTO {
  ...
  */
  ...
  @Schema(name = "message", example = "Error in parameter", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  */
  ...
  @Schema(name = "path", example = "/price", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("path")
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error.code) &&
        ...
        Objects.equals(this.date, error.date) &&
        Objects.equals(this.path, error.path);
  }

  @Override
  public int hashCode() {
    return Objects.hash(code, message, date, path);
  }
